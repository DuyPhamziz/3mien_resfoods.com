...
<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    <div class="position-sticky pt-3">
        <ul class="nav flex-column">
            ...
            <li class="nav-item mb-2">
                <a class="nav-link <?= str_contains($currentPath, '/transactions/') ? 'active bg-warning text-dark' : 'text-dark' ?> rounded d-flex align-items-center gap-2 px-3 py-2" href="../transactions/index.php">
